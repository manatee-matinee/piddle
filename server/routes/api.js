...
/**
 * @api {get} /api/items Retrieve user's claimed items
 * @apiName RetrieveItems
 * @apiGroup Item
 * @apiDescription Retrieves all the items that the authenticated user is the debtor of.
 *
 * @apiPermission user
 *
 * @apiHeader (Authroization) {string} authorization JWT generated by
 ...
 * }
 *
 * @apiSuccess {Object[]} data An array of items
 *
 * @apiSuccessExample Success-Response
 * HTTP/1.1 200 OK
 * { data:
 *    [ { id: 25,
 *        description: '#24 Rice & Imperial Roll, Pork Kebab - sub Rice with Curry Fried Rice',
 *        price: 8.95,
 *        paid: false,
 *        tax: 0.85,
 *        tip: 1,
